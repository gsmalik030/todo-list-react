...
**Todo List App** is a website for Where you can keep track of your daily Todos.
...
- [Live Demo](https://github.com/gsmalik030/todo-list-react) [Coming soon]
...
```sh
  cd math-magicians
  git clone https://github.com/gsmalik030/todo-list-react
```
...
Feel free to check the [issues page](https://github.com/gsmalik030/todo-list-react/issues).
